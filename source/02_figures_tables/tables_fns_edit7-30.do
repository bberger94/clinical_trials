...
program define nih_funding_by_phase
	...
	estimates clear
	eststo p: quietly mean nih_funding
	eststo p1: quietly mean nih_funding if phase_1
	eststo p2: quietly mean nih_funding if phase_2
	eststo p3: quietly mean nih_funding if phase_3
